...
extension TagQueryFilter on QueryBuilder<Tag, Tag, QFilterCondition> {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> isFavoriteEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension TagQuerySortBy on QueryBuilder<Tag, Tag, QSortBy> {
  ...
  QueryBuilder<Tag, Tag, QAfterSortBy> sortByIsFavorite() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFavorite', Sort.asc);
    });
  }

  QueryBuilder<Tag, Tag, QAfterSortBy> sortByIsFavoriteDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TagQuerySortThenBy on QueryBuilder<Tag, Tag, QSortThenBy> {
  ...
  QueryBuilder<Tag, Tag, QAfterSortBy> thenByIsFavorite() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFavorite', Sort.asc);
    });
  }

  QueryBuilder<Tag, Tag, QAfterSortBy> thenByIsFavoriteDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFavorite', Sort.desc);
    });
  }
...
extension TagQueryWhereDistinct on QueryBuilder<Tag, Tag, QDistinct> {
  ...
  QueryBuilder<Tag, Tag, QDistinct> distinctByIsFavorite() {
    return QueryBuilder.apply(this, (query) {
