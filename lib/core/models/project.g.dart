...
const _ProjectlayoutEnumValueMap = {
  'list': 0,
  'kanban': 1,
  'calendar': 2,
};
const _ProjectlayoutValueEnumMap = {
  0: Layout.list,
  1: Layout.kanban,
  2: Layout.calendar,
};
...
extension ProjectQueryFilter
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> layoutEqualTo(
      Layout value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'layout',
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> layoutGreaterThan(
    Layout value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> layoutLessThan(
    Layout value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> layoutBetween(
    Layout lower,
    Layout upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ProjectQueryLinks
    on QueryBuilder<Project, Project, QFilterCondition> {
  QueryBuilder<Project, Project, QAfterFilterCondition> parent(
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> parentIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension ProjectQuerySortBy on QueryBuilder<Project, Project, QSortBy> {
  ...
  QueryBuilder<Project, Project, QAfterSortBy> sortByLayout() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'layout', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> sortByLayoutDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProjectQuerySortThenBy
  ...
  QueryBuilder<Project, Project, QAfterSortBy> thenByLayout() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'layout', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> thenByLayoutDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'layout', Sort.desc);
    });
  }
...
extension ProjectQueryWhereDistinct
  ...
  QueryBuilder<Project, Project, QDistinct> distinctByLayout() {
    return QueryBuilder.apply(this, (query) {
...
extension ProjectQueryProperty
  ...
  QueryBuilder<Project, Layout, QQueryOperations> layoutProperty() {
    return QueryBuilder.apply(this, (query) {
