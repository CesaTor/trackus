...
class TaskAdderOptions extends StatefulWidget {
  const TaskAdderOptions({
  ...
  @override
  State<TaskAdderOptions> createState() => _ItemAdderOptionsState();
}

class _ItemAdderOptionsState extends State<TaskAdderOptions> {
  Project? project;
  DateTime? dueDate;
  TimeOfDay? dueTime;
